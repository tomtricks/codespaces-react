  ...
  return (
    <div className={`feature-card2-feature-card ${props.rootClassName} `}>
      ...
      <div className="feature-card2-container">
        <h2 className="feature-card2-text">{props.Ele}</h2>
        <span className="">{props.Preschool}</span>
      </div>
    </div>
  )
}
...
FeatureCard2.defaultProps = {
  rootClassName: '',
  Ele: 'Preschool',
  Preschool: 'Info for parents of children ages 0-4.',
}

FeatureCard2.propTypes = {
  rootClassName: PropTypes.string,
  Ele: PropTypes.string,
  Preschool: PropTypes.string,
}
